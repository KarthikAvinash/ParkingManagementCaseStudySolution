...
class ExitCarInfo(object):
    ...
    def DeleteDataAndTicket(self):
        #_____NEWELY ADDED STARTS_______________________________________________________________
        mydb.reconnect()
        mycursor = mydb.cursor()
        ...
        if len(rows) == 0:
            ...
            return
        #_____NEWELY ADDED ENDS_______________________________________________________________
        self.DeleteDataDB()
        self.TicketFrame()
