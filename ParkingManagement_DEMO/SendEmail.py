...
class sendParkingTicket(object):
    ...
    def send_Email(self):
        ...
        try:
            ...
            ob.starttls()
            ob.login("<Enter your institute email here (It is sender's email)>", "<Enter your password here>")
            subject = "PARKING TICKET"

            body = self.str
            message = 'Subject : {}\n\n{}'.format(subject, body)
            ob.sendmail("<Enter your institute email here (It is sender's email)>", self.receiverEmail, message)
